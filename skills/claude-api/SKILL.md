---
name: claude-api
description: "Build, debug, and optimize Claude API / Anthropic SDK apps with prompt caching. Handle model migrations. Use for Anthropic SDK code and API features (caching, thinking, tool use, batch, files). Skip for OpenAI or other-provider SDK code."
